...
abstract class UserGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\WildPHP\\Core\\Entities\\Map\\UserGroupTableMap';
    ...
    /**
     * Initializes internal state of WildPHP\Core\Entities\Base\UserGroup object.
     */
     ...
     * @return $this|\WildPHP\Core\Entities\UserGroup The current object (for fluent API support)
     */
    public function setUserIrcAccount($v)
    {
        ...
        if ($this->user_irc_account !== $v) {
            ...
            $this->modifiedColumns[UserGroupTableMap::COL_USER_IRC_ACCOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserGroupTableMap::translateFieldName('UserIrcAccount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\WildPHP\\Core\\Entities\\UserGroup'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserGroupTableMap::COL_USER_IRC_ACCOUNT)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\WildPHP\Core\Entities\UserGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\WildPHP\Core\Entities\UserGroup The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserGroupTableMap::COL_USER_IRC_ACCOUNT)) {
            $criteria->add(UserGroupTableMap::COL_USER_IRC_ACCOUNT, $this->user_irc_account);
        }
        if ($this->isColumnModified(UserGroupTableMap::COL_GROUP_ID)) {
    ...
    {
        return (null === $this->getUserIrcAccount()) && (null === $this->getGroupId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \WildPHP\Core\Entities\UserGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \WildPHP\Core\Entities\UserGroup Clone of current object.
     * @throws PropelException
     */
