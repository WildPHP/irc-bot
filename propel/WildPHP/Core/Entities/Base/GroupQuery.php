 ...
 *
 * @method     ChildGroupQuery leftJoinGroupPolicy($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupPolicy relation
 * @method     ChildGroupQuery rightJoinGroupPolicy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupPolicy relation
 * @method     ChildGroupQuery innerJoinGroupPolicy($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupPolicy relation
 *
 * @method     ChildGroupQuery joinWithGroupPolicy($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the GroupPolicy relation
 *
 * @method     ChildGroupQuery leftJoinWithGroupPolicy() Adds a LEFT JOIN clause and with to the query using the GroupPolicy relation
 * @method     ChildGroupQuery rightJoinWithGroupPolicy() Adds a RIGHT JOIN clause and with to the query using the GroupPolicy relation
 * @method     ChildGroupQuery innerJoinWithGroupPolicy() Adds a INNER JOIN clause and with to the query using the GroupPolicy relation
 *
 * @method     \WildPHP\Core\Entities\UserGroupQuery|\WildPHP\Core\Entities\GroupPolicyQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class GroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \WildPHP\Core\Entities\Base\GroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'persistent', $modelName = '\\WildPHP\\Core\\Entities\\Group', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \WildPHP\Core\Entities\UserGroup object
     *
     * @param \WildPHP\Core\Entities\UserGroup|ObjectCollection $userGroup the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($userGroup instanceof \WildPHP\Core\Entities\UserGroup) {
            return $this
            ...
            throw new PropelException('filterByUserGroup() only accepts arguments of type \WildPHP\Core\Entities\UserGroup or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \WildPHP\Core\Entities\UserGroupQuery A secondary query class using the current class as primary query
     */
    public function useUserGroupQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUserGroup($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserGroup', '\WildPHP\Core\Entities\UserGroupQuery');
    }
    ...
    public function filterByGroupPolicy($groupPolicy, $comparison = null)
    {
        if ($groupPolicy instanceof \WildPHP\Core\Entities\GroupPolicy) {
            return $this
                ->addUsingAlias(GroupTableMap::COL_ID, $groupPolicy->getGroupId(), $comparison);
