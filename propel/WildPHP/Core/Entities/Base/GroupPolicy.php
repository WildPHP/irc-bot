...
/**
 * Base class that represents a row from the 'group_policy' table.
 *
 *
 *
 * @package    propel.generator.WildPHP.Core.Entities.Base
 */
abstract class GroupPolicy implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\WildPHP\\Core\\Entities\\Map\\GroupPolicyTableMap';
    ...
    /**
     * Initializes internal state of WildPHP\Core\Entities\Base\GroupPolicy object.
     */
    ...
    /**
     * Compares this with another <code>GroupPolicy</code> instance.  If
     * <code>obj</code> is an instance of <code>GroupPolicy</code>, delegates to
     * <code>equals(GroupPolicy)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GroupPolicy The current object, for fluid interface
     */
     ...
     * @return $this|\WildPHP\Core\Entities\GroupPolicy The current object (for fluent API support)
     */
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[GroupPolicyTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function setPolicyName($v)
    {
        ...
        if ($this->policy_name !== $v) {
            $this->policy_name = $v;
            $this->modifiedColumns[GroupPolicyTableMap::COL_POLICY_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupPolicyTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupPolicyTableMap::translateFieldName('PolicyName', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = GroupPolicyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\WildPHP\\Core\\Entities\\GroupPolicy'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGroupPolicyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GroupPolicy::setDeleted()
     * @see GroupPolicy::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGroupPolicyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupPolicyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GroupPolicyTableMap::COL_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'group_id';
        }
        if ($this->isColumnModified(GroupPolicyTableMap::COL_POLICY_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'policy_name';
        }

        $sql = sprintf(
            'INSERT INTO group_policy (%s) VALUES (%s)',
    ...
    {
        $pos = GroupPolicyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GroupPolicy'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GroupPolicy'][$this->hashCode()] = true;
        $keys = GroupPolicyTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\WildPHP\Core\Entities\GroupPolicy
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\WildPHP\Core\Entities\GroupPolicy The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupPolicyTableMap::COL_GROUP_ID)) {
            $criteria->add(GroupPolicyTableMap::COL_GROUP_ID, $this->group_id);
        }
        if ($this->isColumnModified(GroupPolicyTableMap::COL_POLICY_NAME)) {
            $criteria->add(GroupPolicyTableMap::COL_POLICY_NAME, $this->policy_name);
        }
    ...
    {
        $criteria = ChildGroupPolicyQuery::create();
        $criteria->add(GroupPolicyTableMap::COL_GROUP_ID, $this->group_id);
        $criteria->add(GroupPolicyTableMap::COL_POLICY_NAME, $this->policy_name);
    ...
    public function hashCode()
    {
        ...
        //relation group_policy_fk_0278b4 to table group
        ...
        //relation group_policy_fk_7db62c to table policy
    ...
    {
        return (null === $this->getGroupId()) && (null === $this->getPolicyName());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \WildPHP\Core\Entities\GroupPolicy (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \WildPHP\Core\Entities\GroupPolicy Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGroup(ConnectionInterface $con = null)
    {
        if ($this->aGroup === null && ($this->group_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroup->addGroupPolicies($this);
             */
        }
    ...
    public function getPolicy(ConnectionInterface $con = null)
    {
        if ($this->aPolicy === null && (($this->policy_name !== "" && $this->policy_name !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPolicy->addGroupPolicies($this);
             */
        }
     ...
     * If this ChildGroupPolicy is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGroupPolicy The current object (for fluent API support)
     */
    public function setGroupPolicyRestrictions(Collection $groupPolicyRestrictions, ConnectionInterface $con = null)
    {
        ...
        foreach ($groupPolicyRestrictionsToDelete as $groupPolicyRestrictionRemoved) {
            $groupPolicyRestrictionRemoved->setGroupPolicy(null);
        }
    ...
    protected function doAddGroupPolicyRestriction(ChildGroupPolicyRestriction $groupPolicyRestriction)
    {
        ...
        $groupPolicyRestriction->setGroupPolicy($this);
    }
    ...
    public function removeGroupPolicyRestriction(ChildGroupPolicyRestriction $groupPolicyRestriction)
    {
        if ($this->getGroupPolicyRestrictions()->contains($groupPolicyRestriction)) {
            ...
            $groupPolicyRestriction->setGroupPolicy(null);
        }
     ...
     * Otherwise if this GroupPolicy is new, it will return
     * an empty collection; or if this GroupPolicy has previously
     * been saved, it will retrieve related GroupPolicyRestrictions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GroupPolicy.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildGroupPolicyRestriction[] List of ChildGroupPolicyRestriction objects
     */
    public function getGroupPolicyRestrictionsJoinIrcChannel(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGroupPolicyRestrictionQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aGroup) {
            $this->aGroup->removeGroupPolicy($this);
        }
        if (null !== $this->aPolicy) {
            $this->aPolicy->removeGroupPolicy($this);
        }
        $this->group_id = null;
    ...
    {
        return (string) $this->exportTo(GroupPolicyTableMap::DEFAULT_STRING_FORMAT);
    }
