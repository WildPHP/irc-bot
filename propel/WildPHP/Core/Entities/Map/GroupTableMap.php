...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'WildPHP.Core.Entities.Map.GroupTableMap';
     ...
     */
    const OM_CLASS = '\\WildPHP\\Core\\Entities\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'WildPHP.Core.Entities.Group';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\WildPHP\\Core\\Entities\\Group');
    ...
    {
        $this->addRelation('UserGroup', '\\WildPHP\\Core\\Entities\\UserGroup', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':group_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \WildPHP\Core\Entities\Group) { // it's a model object
